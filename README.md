...
> 详细进度见 [docs/STATUS.md](docs/STATUS.md)，过程记录见 [docs/DEVELOPMENT_LOG.md](docs/DEVELOPMENT_LOG.md)，产品需求见 [docs/PRD.md](docs/PRD.md)，技术风险见 [docs/TECH_RISKS.md](docs/TECH_RISKS.md)，CLI 契约见 [docs/CLI_SPEC.md](docs/CLI_SPEC.md)，MVP 任务见 [docs/MVP_TASKS.md](docs/MVP_TASKS.md)。
